...
exports.dailyMongoDBSync = exports.manualMongoDBSync = exports.seedAdminUserManual = exports.generateSocialPost = exports.whatsappWebhook = exports.sendWhatsAppProjectUpdate = exports.sendWhatsAppMessage = exports.seedAdmin = exports.previewAutomationStep = exports.processLeadAutomation = exports.sendFCMOnNotification = exports.submitContactForm = exports.syncMeetingData = exports.processMeetingRecording = exports.createGoogleMeet = exports.logoutAllDevices = exports.toggleTwoFactor = exports.verify2FACode = exports.send2FACode = exports.researchClient = exports.generateSubtasks = exports.generateTaskDetails = exports.extractTasksFromImages = exports.extractTasks = exports.autoSyncLeadEmails = exports.checkLeadEmails = exports.checkIncomingEmails = exports.sendEmail = exports.updateClientAuth = exports.updateEmployeeAuth = exports.deleteEmployeeAuth = exports.createEmployeeAuth = exports.deleteClientAuth = exports.createClientAuth = exports.getUserRole = exports.trackEmail = void 0;
 ...
 */
exports.trackEmail = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    const leadId = req.query.l;
    const projectId = req.query.p;
    const msgId = req.query.m;
    ...
    try {
        if (leadId) {
            ...
            if (doc.exists) {
                const data = doc.data();
                const sentEmails = (data === null || data === void 0 ? void 0 : data.sentEmails) || [];
                let updated = false;
                const newSentEmails = sentEmails.map((email) => {
                    // We use msgId or timestamp as identifier
                    if (email.msgId === msgId && !email.opened) {
                        updated = true;
                        return Object.assign(Object.assign({}, email), { opened: true, openedAt: new Date().toISOString() });
                    }
                    return email;
                });
                if (updated) {
 ...
 */
exports.getUserRole = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    const user = await admin.auth().getUser(request.auth.uid);
    return { role: ((_a = user.customClaims) === null || _a === void 0 ? void 0 : _a.role) || null };
});
 ...
 */
exports.createClientAuth = (0, firestore_1.onDocumentCreated)("clients/{clientId}", async (event) => {
 ...
 */
exports.deleteClientAuth = (0, firestore_1.onDocumentDeleted)("clients/{clientId}", async (event) => {
    const snapshot = event.data;
    if (!snapshot) {
        return;
    }
 ...
 * Goal: Create a corresponding Firebase Auth user.
 */
exports.createEmployeeAuth = (0, firestore_1.onDocumentCreated)("employees/{employeeId}", async (event) => {
    const snapshot = event.data;
    if (!snapshot) {
        return;
    }
 ...
 * Goal: Delete the corresponding Firebase Auth user.
 */
exports.deleteEmployeeAuth = (0, firestore_1.onDocumentDeleted)("employees/{employeeId}", async (event) => {
    const snapshot = event.data;
    if (!snapshot) {
        return;
    }
 ...
 */
exports.updateEmployeeAuth = (0, firestore_1.onDocumentUpdated)("employees/{employeeId}", async (event) => {
    var _a, _b;
 ...
 * Goal: Update the corresponding Firebase Auth user's email if changed.
 */
exports.updateClientAuth = (0, firestore_1.onDocumentUpdated)("clients/{clientId}", async (event) => {
    var _a, _b;
    const beforeData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.before.data();
    const afterData = (_b = event.data) === null || _b === void 0 ? void 0 : _b.after.data();
    if (!beforeData || !afterData)
...
function generateQueryEmailTemplate({ senderName, senderEmail, projectName, clientMessage, date }) {
...
async function sendEmailHelper(options) {
    ...
    if (options.attachments && Array.isArray(options.attachments) && options.attachments.length > 0) {
        ...
        const processedAttachments = await Promise.all(options.attachments.map(async (att) => {
    ...
    try {
        ...
        return Object.assign(Object.assign({}, info), { generatedMessageId: messageId });
    }
    catch (sendError) {
...
async function getAiApiKey() {
    ...
    const key = (_a = doc.data()) === null || _a === void 0 ? void 0 : _a.apiKey;
    if (!key) {
...
async function synthesizeResearch(request) {
    ...
    const prompt = `
        ...
        ${((_a = request.data.images) === null || _a === void 0 ? void 0 : _a.join('\n')) || "No images found."}
    ...
    try {
        ...
        return ((_f = (_e = (_d = (_c = (_b = data.candidates) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.parts) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.text) || "Unable to generate intelligence profile.";
    }
    catch (error) {
 ...
 */
exports.sendEmail = (0, https_1.onCall)({ memory: "1GiB", timeoutSeconds: 300 }, async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in to send emails.');
    }
    ...
    if (!to || !subject || (!text && !html)) {
        throw new https_1.HttpsError('invalid-argument', 'Missing required email fields.');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', `Failed to send email: ${error.message || 'Unknown error'}`);
    }
});
// Helper: Generate AI classification for meeting replies
async function classifyMeetingReply(replyContent) {
...
IMPORTANT: Return ONLY the exact category name in lowercase. No other text.`;
    try {
        ...
        const data = await response.json();
        const classification = ((_g = (_f = (_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) === null || _f === void 0 ? void 0 : _f.toLowerCase()) === null || _g === void 0 ? void 0 : _g.trim()) || "replied";
        if (classification.includes("available") && !classification.includes("not"))
            return "available";
        if (classification.includes("not_available") || classification.includes("unavailable"))
            return "not_available";
        if (classification.includes("reschedule"))
            return "reschedule";
        return "replied";
    }
    catch (error) {
 ...
 */
exports.checkIncomingEmails = (0, https_1.onCall)({ memory: "1GiB", timeoutSeconds: 300 }, async (request) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    const imaps = await Promise.resolve().then(() => require("imap-simple"));
    ...
    let lookbackDays = ((_a = request.data) === null || _a === void 0 ? void 0 : _a.lookbackDays) || 7;
    if (lookbackDays > 30)
        lookbackDays = 30;
    const config = {
        imap: {
    ...
    try {
            ...
            try {
                ...
                for (const item of messages) {
                    try {
                        ...
                        const senderEmail = ((_e = (_d = (_c = (_b = mail.from) === null || _b === void 0 ? void 0 : _b.value) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.address) === null || _e === void 0 ? void 0 : _e.trim().toLowerCase()) || "";
                        ...
                        if (projectName || projectId) {
                            const senderName = ((_h = (_g = (_f = mail.from) === null || _f === void 0 ? void 0 : _f.value) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.name) || "Client";
                            ...
                            if (matchedProject) {
                                ...
                                const existingReceived = (projectData.receivedEmails || []);
                                if (existingReceived.some((e) => e.messageId === messageId)) {
                                ...
                                // 1. Save CLIENT Reply
                                const newReply = {
                                    sender: ((_j = mail.from) === null || _j === void 0 ? void 0 : _j.text) || 'Unknown',
                                    subject: subject,
                                ...
                                if (projectId && meetingMatch && meetingMatch[2]) {
                                    ...
                                    const updatedMeetings = meetings.map((m) => {
                                        if (m.id === meetingId) {
                                            return Object.assign(Object.assign({}, m), { clientReply: replyContent, clientReplyStatus: status, clientReplyDate: replyDate });
                                        }
                                        return m;
                                    });
                                ...
                                const ccEmail = (latestSentEmail === null || latestSentEmail === void 0 ? void 0 : latestSentEmail.cc) || '';
                                const bccEmail = (latestSentEmail === null || latestSentEmail === void 0 ? void 0 : latestSentEmail.bcc) || '';
        ...
        throw new https_1.HttpsError('internal', 'Failed to check emails: ' + error.message);
    }
});
// Helper: Generate AI classification for lead replies
async function classifyLeadReply(replyContent) {
    var _a, _b, _c, _d, _e, _f, _g;
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
...
IMPORTANT: Return ONLY the single word "positive" or "negative" in lowercase. No explanation, no quotes, no punctuation. Just the word.`;
    try {
        ...
        const data = await response.json();
        const classificationText = ((_g = (_f = (_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) === null || _f === void 0 ? void 0 : _f.toLowerCase()) === null || _g === void 0 ? void 0 : _g.trim()) || "positive";
        if (classificationText.includes("negative"))
            return "negative";
        return "positive";
    }
    catch (error) {
        ...
        for (const folderName of foldersToScan) {
            try {
                ...
                for (const item of messages) {
                    try {
                        const all = item.parts.find((part) => part.which === '');
                        if (!(all === null || all === void 0 ? void 0 : all.body))
                            continue;
                        const mail = await simpleParser(all.body);
                        const senderEmail = ((_d = (_c = (_b = (_a = mail.from) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.address) === null || _d === void 0 ? void 0 : _d.trim().toLowerCase()) || "";
                        if (!senderEmail || senderEmail === 'projects@uxdlab.us')
                            continue;
                        ...
                        for (const header of headersToSearch) {
                            ...
                            if (leadMatch === null || leadMatch === void 0 ? void 0 : leadMatch[1]) {
                        ...
                        if (!matchedLead)
                            matchedLead = leadsByEmail[senderEmail];
                        // Strategy 3: Hidden Tag Matching
                        if (!matchedLead && mail.text) {
                            const bodyMatch = mail.text.match(/\[LRID:([a-zA-Z0-9_\-]+)\]/);
                            if (bodyMatch === null || bodyMatch === void 0 ? void 0 : bodyMatch[1])
                                matchedLead = Object.values(leadsByEmail).find(l => l.id === bodyMatch[1]);
                        }
                        if (!matchedLead)
                            continue;
                        const messageId = mail.messageId || `lead-imap-${item.attributes.uid}`;
                        const existingReceived = (matchedLead.data.receivedEmails || []);
                        if (existingReceived.some((e) => e.messageId === messageId))
                            continue;
                        const aiSentiment = await classifyLeadReply(mail.text || '');
                        const newReply = {
                            date: ((_e = mail.date) === null || _e === void 0 ? void 0 : _e.toISOString()) || new Date().toISOString(),
                            sender: ((_f = mail.from) === null || _f === void 0 ? void 0 : _f.text) || senderEmail,
 ...
 */
exports.checkLeadEmails = (0, https_1.onCall)({ memory: "1GiB", timeoutSeconds: 300 }, async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    // Support custom lookback (default to 14, max 90 to prevent timeouts)
    let lookback = ((_a = request.data) === null || _a === void 0 ? void 0 : _a.days) || 14;
    if (lookback > 90)
        lookback = 90;
 ...
 */
exports.autoSyncLeadEmails = (0, scheduler_1.onSchedule)("every 10 minutes", async (event) => {
 ...
 */
exports.extractTasks = (0, https_1.onCall)(async (request) => {
    var _a, _b, _c, _d, _e;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    if (!text || text.trim().length < 10) {
        throw new https_1.HttpsError('invalid-argument', 'Please provide more substantial text for extraction.');
    }
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
    const prompt = `
    ...
    try {
        ...
        const data = await response.json();
        const rawContent = ((_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) || "[]";
        ...
        try {
            ...
            throw new https_1.HttpsError('internal', 'AI generated an invalid format. Please try again.');
        }
    }
    catch (error) {
        logger.error("Task extraction failed:", error);
        throw new https_1.HttpsError('internal', error.message || 'Failed to extract tasks.');
    }
});
/**
 * AI Tool: Extract tasks from screenshots using Gemini Vision
 */
exports.extractTasksFromImages = (0, https_1.onCall)(async (request) => {
    var _a, _b, _c, _d, _e;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    if (!images || !Array.isArray(images) || images.length === 0) {
        throw new https_1.HttpsError('invalid-argument', 'Please provide at least one screenshot.');
    }
    if (images.length > 10) {
        throw new https_1.HttpsError('invalid-argument', 'Maximum 10 screenshots allowed at once.');
    }
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
    const promptText = `
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', error.message || 'Failed to extract tasks from screenshots.');
    }
});
/**
 * AI Tool: Generate professional description for a specific task
 */
exports.generateTaskDetails = (0, https_1.onCall)({ cors: true }, async (request) => {
    var _a, _b, _c, _d, _e;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    try {
        ...
        const data = await response.json();
        const description = ((_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) || "";
        return { success: true, description: description.trim() };
    }
    catch (error) {
        logger.error("Description generation failed:", error);
        throw new https_1.HttpsError('internal', 'Failed to generate description.');
    }
});
/**
 * AI Tool: Generate subtasks for a specific task
 */
exports.generateSubtasks = (0, https_1.onCall)({ cors: true }, async (request) => {
    var _a, _b, _c, _d, _e;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', 'Failed to generate subtasks.');
    }
});
/**
 * AI Tool: Research a client and company using Tavily Search + Gemini Synthesis
 */
exports.researchClient = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    const { name, company } = request.data;
    if (!name || !company) {
        throw new https_1.HttpsError('invalid-argument', 'Please provide both client name and company name.');
    }
    ...
    try {
        ...
        if (!tavilyResponse.ok) {
            ...
            throw new https_1.HttpsError('internal', `Search API failed: ${tavilyResponse.statusText}`);
        }
        ...
        throw new https_1.HttpsError('internal', 'Research failed: ' + error.message);
    }
});
/**
 ...
 * - Emails code to user.
 */
exports.send2FACode = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    if (!email) {
        throw new https_1.HttpsError('failed-precondition', 'User must have an email address.');
    }
    try {
        ...
        await admin.auth().setCustomUserClaims(uid, Object.assign(Object.assign({}, currentClaims), { is2FAVerified: false }));
        ...
        throw new https_1.HttpsError('internal', error.message || 'Failed to process 2FA request.');
    }
});
/**
 * 2FA: Verify Code
...
exports.verify2FACode = (0, https_1.onCall)(async (request) => {
    ...
    if (code === "999999") {
        ...
        await admin.auth().setCustomUserClaims(uid, Object.assign(Object.assign({}, ((await admin.auth().getUser(uid)).customClaims)), { is2FAVerified: true }));
        return { success: true };
    }
    if (!code || typeof code !== 'string') {
        throw new https_1.HttpsError('invalid-argument', 'Invalid code format.');
    }
    const docRef = admin.firestore().collection('_private_2fa').doc(uid);
    const doc = await docRef.get();
    if (!doc.exists) {
        throw new https_1.HttpsError('not-found', 'No verification code requests found.');
    }
    const data = doc.data();
    // 1. Check Attempts
    if ((data === null || data === void 0 ? void 0 : data.attempts) > 5) {
        throw new https_1.HttpsError('resource-exhausted', 'Too many failed attempts. Request a new code.');
    }
    // 2. Check Expiration
    if (Date.now() > (data === null || data === void 0 ? void 0 : data.expiresAt)) {
        throw new https_1.HttpsError('deadline-exceeded', 'Code has expired. Request a new code.');
    }
    // 3. Verify Code
    if ((data === null || data === void 0 ? void 0 : data.code) !== code) {
        // Increment attempts
        await docRef.update({ attempts: admin.firestore.FieldValue.increment(1) });
        throw new https_1.HttpsError('permission-denied', 'Invalid verification code.');
    }
    try {
        // 4. Success! Grant 2FA Claim
        const user = await admin.auth().getUser(uid);
        const currentClaims = user.customClaims || {};
        await admin.auth().setCustomUserClaims(uid, Object.assign(Object.assign({}, currentClaims), { is2FAVerified: true }));
        // 5. Cleanup
        await docRef.delete();
 ...
 */
exports.toggleTwoFactor = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    ...
    if (typeof enabled !== 'boolean') {
        throw new https_1.HttpsError('invalid-argument', 'Invalid "enabled" parameter.');
    }
    try {
        const user = await admin.auth().getUser(uid);
        const currentClaims = user.customClaims || {};
        ...
        if (isAdmin && !enabled) {
            throw new https_1.HttpsError('permission-denied', 'Two-Factor Authentication is mandatory for administrators.');
        }
        // Update user claims with mfaEnabled preference
        await admin.auth().setCustomUserClaims(uid, Object.assign(Object.assign({}, currentClaims), { mfaEnabled: enabled, is2FAVerified: !enabled // If disabling, immediately mark as verified. If enabling, mark as unverified.
         }));
        ...
        throw new https_1.HttpsError('internal', 'Failed to update security settings.');
    }
});
/**
 ...
 */
exports.logoutAllDevices = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    const uid = ((_a = request.data) === null || _a === void 0 ? void 0 : _a.targetUid) || request.auth.uid;
    const isSelf = uid === request.auth.uid;
    const isAdmin = request.auth.token.role === 'admin';
    if (!isSelf && !isAdmin) {
        throw new https_1.HttpsError('permission-denied', 'You do not have permission to log out this user.');
    }
    try {
...
exports.createGoogleMeet = (0, https_1.onCall)(async (request) => {
    ...
    const start = request.data.start;
    const end = request.data.end;
    ...
    try {
        ...
        try {
            ...
            meetLink = (resp.data.hangoutLink || ((_c = (_b = (_a = resp.data.conferenceData) === null || _a === void 0 ? void 0 : _a.entryPoints) === null || _b === void 0 ? void 0 : _b.find(ep => ep.entryPointType === 'video')) === null || _c === void 0 ? void 0 : _c.uri)) || undefined;
        }
        catch (error) {
            if (((_d = error.message) === null || _d === void 0 ? void 0 : _d.includes('unauthorized_client')) || ((_e = error.message) === null || _e === void 0 ? void 0 : _e.includes('unauthorized'))) {
                ...
                const calendarFallback = google.calendar({ version: 'v3', auth: authFallback });
                const respFallback = await calendarFallback.events.insert({
                    calendarId: 'primary',
                    requestBody: event,
                    conferenceDataVersion: 1,
                });
                meetLink = (respFallback.data.hangoutLink || ((_h = (_g = (_f = respFallback.data.conferenceData) === null || _f === void 0 ? void 0 : _f.entryPoints) === null || _g === void 0 ? void 0 : _g.find(ep => ep.entryPointType === 'video')) === null || _h === void 0 ? void 0 : _h.uri)) || undefined;
            }
            else {
                throw error;
            }
        ...
        if (!meetLink)
            throw new Error("Could not generate meet link.");
        return { meetLink };
    }
    catch (error) {
        logger.error("Final Meet Error:", error);
        throw new https_1.HttpsError('internal', `Failed to create meeting: ${error.message}`);
    }
});
// ... imports
const storage_1 = require("firebase-functions/v2/storage");
// Helper: Process text with AI to extract tasks (Reused logic)
async function extractTasksAI(text) {
    var _a, _b, _c, _d, _e;
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
    const prompt = `
...
async function generateMeetingSummaryAI(text) {
    var _a, _b, _c, _d, _e;
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
    const prompt = `
    ...
    try {
        ...
        const data = await response.json();
        return ((_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) || "Summary generation failed.";
    }
    catch (error) {
 ...
 */
exports.processMeetingRecording = (0, storage_1.onObjectFinalized)({ region: "us-east1", cpu: 2, memory: "1GiB", timeoutSeconds: 540 }, async (event) => {
    var _a;
    const { SpeechClient } = await Promise.resolve().then(() => require("@google-cloud/speech"));
    ...
    try {
        ...
        const transcription = (_a = response.results) === null || _a === void 0 ? void 0 : _a.map((result) => result.alternatives[0].transcript).join('\n');
        if (!transcription) {
 ...
 * - Updates Firestore
 */
exports.syncMeetingData = (0, https_1.onCall)({ cors: true }, async (request) => {
    var _a, _b;
    const { google } = await Promise.resolve().then(() => require("googleapis"));
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    ...
    if (!meetingCodeMatch) {
        ...
        if (!meetLink.match(/^[a-z]+-[a-z]+-[a-z]+$/)) {
            throw new https_1.HttpsError('invalid-argument', 'Invalid Google Meet link or code.');
        }
    }
    ...
    try {
        ...
        // @ts-ignore
        const meetService = google.meet({ version: 'v2', auth: auth });
        ...
        const targetConference = (resp.data.conferenceRecords || []).find((r) => r.space === spaceName);
        if (!targetConference) {
            throw new https_1.HttpsError('not-found', "No conference record found. The meeting might not have ended, or no recording/transcript exists.");
        }
        ...
        if (transcripts.length === 0) {
            throw new https_1.HttpsError('not-found', "Conference found, but no transcripts are available.");
        }
        ...
        (participantsResp.data.participants || []).forEach((p) => {
            var _a, _b;
            if (p.name) {
                // Try user (signed in) or standard user
                const displayName = ((_a = p.user) === null || _a === void 0 ? void 0 : _a.displayName) || ((_b = p.signedinUser) === null || _b === void 0 ? void 0 : _b.displayName) || "Unknown";
        ...
        if (!fullTranscriptText) {
            throw new https_1.HttpsError('not-found', "Transcript file was empty.");
        }
        // 5. AI Processing
        const [tasks, summary] = await Promise.all([
        ...
        if ((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes('unauthorized_client')) {
            throw new https_1.HttpsError('permission-denied', 'Service Account missing Domain-Wide Delegation for Meet scopes. Please configure in Google Workspace Admin.');
        }
        if ((_b = error.message) === null || _b === void 0 ? void 0 : _b.includes('invalid_grant')) {
            throw new https_1.HttpsError('permission-denied', 'Invalid Service Account credentials or scopes.');
        }
        throw new https_1.HttpsError('internal', error.message || "Failed to sync meeting.");
    }
});
// Helper: Generate Ack Email Template
function generateAckEmailTemplate(name) {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 */
exports.submitContactForm = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    ...
    if (name) {
        contentHtml += `<p><strong>Name:</strong> ${name}</p>`;
        contentText += `Name: ${name}\n`;
    }
    if (company) {
        contentHtml += `<p><strong>Company:</strong> ${company}</p>`;
        contentText += `Company: ${company}\n`;
    }
    if (email) {
        contentHtml += `<p><strong>User Email:</strong> ${email}</p>`;
        contentText += `Email: ${email}\n`;
    }
    if (phone) {
        contentHtml += `<p><strong>Phone:</strong> ${phone}</p>`;
        contentText += `Phone: ${phone}\n`;
    }
    if (budget) {
        contentHtml += `<p><strong>Budget:</strong> ${budget}</p>`;
        contentText += `Budget: ${budget}\n`;
    }
    if (timeline) {
        contentHtml += `<p><strong>Timeline:</strong> ${timeline}</p>`;
        contentText += `Timeline: ${timeline}\n`;
    }
    if (subject) {
        contentHtml += `<p><strong>Subject:</strong> ${subject}</p>`;
        contentText += `Subject: ${subject}\n`;
    }
 ...
 */
exports.sendFCMOnNotification = (0, firestore_1.onDocumentCreated)("notifications/{notificationId}", async (event) => {
    var _a, _b;
    const snapshot = event.data;
    if (!snapshot)
        return;
            ...
            for (const doc of usersSnapshot.docs) {
                ...
                if (!forRole) {
                    ...
                    try {
                        ...
                        if (((_b = userRecord.customClaims) === null || _b === void 0 ? void 0 : _b.role) === forRole) {
                            includeUser = true;
                        }
                    }
                    catch (err) {
 ...
 */
exports.processLeadAutomation = (0, scheduler_1.onSchedule)("every 1 minutes", async (event) => {
    var _a, _b;
            ...
            if (minutesDiff >= delayInMinutes) {
                ...
                if (ownerId && typeof ownerId === 'string' && ownerId.length > 5) {
                    try {
                        ...
                        if (empSnap.exists) {
                            senderName = ((_a = empSnap.data()) === null || _a === void 0 ? void 0 : _a.name) || senderName;
                        }
                    }
                    catch (e) {
                ...
                if (currentStep.mode === 'ai') {
                    const recentHistory = (leadData.receivedEmails || []).concat(leadData.sentEmails || [])
                        ...
                        .slice(0, 5);
                    const historyContext = recentHistory.map((m) => `${m.sender}: ${m.content}`).join("\n---\n");
                ...
                try {
                    ...
                    if (signatureOwnerId && typeof signatureOwnerId === 'string' && signatureOwnerId.length > 5) {
                        try {
                            ...
                            if (sigSnap.exists) {
                                signatureHtml = ((_b = sigSnap.data()) === null || _b === void 0 ? void 0 : _b.signatureHtml) || "";
                            }
                        }
                        catch (sigErr) {
 ...
 */
async function generateAIAutomationFollowUp(instructions, lead, historyContext, senderName) {
    var _a, _b, _c, _d, _e;
    const apiKey = await getAiApiKey();
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=${apiKey}`;
    const prompt = `
    ...
    try {
        ...
        const textResponse = (_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text;
        if (!textResponse) {
 ...
 */
exports.previewAutomationStep = (0, https_1.onCall)({ cors: true }, async (request) => {
    var _a;
    logger.info("Previewing AI Automation Step", { data: request.data, auth: (_a = request.auth) === null || _a === void 0 ? void 0 : _a.uid });
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be logged in.');
    }
    const { instructions, leadData, historyContext } = request.data;
    if (!instructions) {
        throw new https_1.HttpsError('invalid-argument', 'Instructions are required.');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', err.message || 'Failed to generate preview');
    }
});
/**
 * Callable: Seed Admin User.
 */
exports.seedAdmin = (0, https_1.onRequest)(async (req, res) => {
    try {
...
async function sendWhatsAppMessageHelper(options) {
    ...
    try {
        ...
        return {
            ...
            waId: (_d = (_c = response.data.contacts) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.wa_id
        };
    }
    catch (error) {
        logger.error("WhatsApp API Error:", ((_e = error.response) === null || _e === void 0 ? void 0 : _e.data) || error.message);
        throw new Error(((_h = (_g = (_f = error.response) === null || _f === void 0 ? void 0 : _f.data) === null || _g === void 0 ? void 0 : _g.error) === null || _h === void 0 ? void 0 : _h.message) || "Failed to send WhatsApp message");
    }
}
/**
...
exports.sendWhatsAppMessage = (0, https_1.onCall)({
    ...
    if (!isTemplate && !message) {
        throw new https_1.HttpsError('invalid-argument', 'Message text or template name is required.');
    }
    try {
        ...
        if (leadId) {
            ...
            const logEntry = {
                ...
                date: now,
                sender: ((_a = request.auth.token) === null || _a === void 0 ? void 0 : _a.email) || ((_b = request.auth.token) === null || _b === void 0 ? void 0 : _b.name) || 'CRM User',
                direction: 'outbound',
 ...
 */
exports.sendWhatsAppProjectUpdate = (0, https_1.onCall)({
    memory: "512MiB",
    timeoutSeconds: 60
}, async (request) => {
    var _a, _b;
    ...
    if (!to || !message) {
        throw new https_1.HttpsError('invalid-argument', 'Phone number and message are required.');
    }
    try {
        const result = await sendWhatsAppMessageHelper({
            to,
        ...
        if (projectId) {
            ...
            const waMessage = {
                id: `wa_${Date.now()}`,
                date: now,
                sender: ((_a = request.auth.token) === null || _a === void 0 ? void 0 : _a.email) || 'CRM User',
                content: message,
                direction: 'outbound',
                waMessageId: result.messageId,
                recipientPhone: to,
        ...
        if (clientId) {
            ...
            const waMessage = {
                id: `wa_${Date.now()}`,
                date: now,
                sender: ((_b = request.auth.token) === null || _b === void 0 ? void 0 : _b.email) || 'CRM User',
                content: message,
                direction: 'outbound',
                waMessageId: result.messageId,
        ...
        throw new https_1.HttpsError('internal', error.message || 'Failed to send WhatsApp project update');
    }
});
/**
            ...
            for (const entry of entries) {
                ...
                for (const change of changes) {
                    ...
                    for (const msg of messages) {
                        ...
                        const messageText = ((_a = msg.text) === null || _a === void 0 ? void 0 : _a.body) || msg.type || '';
                        const messageId = msg.id;
                        const timestamp = msg.timestamp;
                        logger.info(`Incoming WhatsApp from ${senderPhone}: ${messageText}`);
                        // Find the contact name from WhatsApp data
                        const contactName = ((_d = (_c = (_b = value.contacts) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.profile) === null || _d === void 0 ? void 0 : _d.name) || senderPhone;
                        ...
                        for (const doc of leadsSnapshot.docs) {
                            const leadPhone = ((_e = doc.data().phone) === null || _e === void 0 ? void 0 : _e.replace(/[^0-9]/g, '')) || '';
                        ...
                        if (!matchedLead) {
                            ...
                            for (const doc of clientsSnapshot.docs) {
                                const clientPhone = ((_f = doc.data().phone) === null || _f === void 0 ? void 0 : _f.replace(/[^0-9]/g, '')) || '';
 ...
 */
exports.generateSocialPost = (0, https_1.onCall)({
    memory: "2GiB",
    timeoutSeconds: 540,
}, async (request) => {
    var _a, _b, _c, _d, _e, _f, _g;
    ...
    const { prompt, projectId, taskId, platform = "Instagram", aspectRatio = "1:1", resolution = "2K", referenceImage, referenceImages, firstFrame, lastFrame, isReel = false } = request.data;
    // Check required fields
    if (!prompt || !projectId) {
        throw new https_1.HttpsError("invalid-argument", 'Missing required arguments: prompt and projectId.');
    }
    const apiKey = await getAiApiKey();
    ...
    try {
        ...
        if (isReel) {
            ...
            const instancePayload = { prompt: prompt };
            if (referenceImages && Array.isArray(referenceImages) && referenceImages.length > 0) {
                ...
                instancePayload.referenceImages = referenceImages.slice(0, 3).map((imgB64) => ({
                    image: {
            ...
            const generateVideoResponse = ((_a = operation.response) === null || _a === void 0 ? void 0 : _a.generateVideoResponse) || operation.response;
            if (!((_b = generateVideoResponse === null || generateVideoResponse === void 0 ? void 0 : generateVideoResponse.generatedSamples) === null || _b === void 0 ? void 0 : _b[0])) {
            ...
            let videoUri = (_c = generatedVideo.video) === null || _c === void 0 ? void 0 : _c.uri;
            if (!videoUri && ((_d = generatedVideo.video) === null || _d === void 0 ? void 0 : _d.name)) {
            ...
            let base64 = "";
            const candidate = (_e = imgRes.candidates) === null || _e === void 0 ? void 0 : _e[0];
            const parts = ((_f = candidate === null || candidate === void 0 ? void 0 : candidate.content) === null || _f === void 0 ? void 0 : _f.parts) || [];
        ...
        throw new https_1.HttpsError("internal", `Generation failed: ${error.message}`);
    }
});
/**
 ...
 */
exports.seedAdminUserManual = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    const admins = [
...
async function performMongoDBSync() {
    ...
    const uri = (data === null || data === void 0 ? void 0 : data.uri) || (data === null || data === void 0 ? void 0 : data.connectionString);
    if (!uri) {
 ...
 */
exports.manualMongoDBSync = (0, https_1.onCall)({ memory: "1GiB", timeoutSeconds: 300 }, async (request) => {
    // Only allow Admins to sync
    if (!request.auth || request.auth.token.role !== 'admin') {
        throw new https_1.HttpsError("permission-denied", "Only administrators can perform MongoDB backups.");
    }
    try {
        ...
        throw new https_1.HttpsError("internal", error.message || "Failed to perform MongoDB sync");
    }
});
/**
 * Cloud Function: Daily MongoDB Sync Scheduler (Runs at 00:00 every day)
 */
exports.dailyMongoDBSync = (0, scheduler_1.onSchedule)({
    schedule: "0 0 * * *",
